          ...
          <Grid container justify="center" className={classes.mainContainer}>
              ...
              <Grid item className={classes.gridItem}> 
                  <Grid container direction="column" spacing={2}>
                      ...
                      <Grid item component={Link} to={'/customsoftware'} oClick={()=> {props.setValue(1); props.setSelectedIndex(1)}} className={classes.link}>Custom Software Development</Grid>
                      <Grid item component={Link} to={'/mobileapps'} onClick={()=> {props.setValue(1); props.setSelectedIndex(2)}} className={classes.link}>iOS/Android App Development</Grid>
                      <Grid item component={Link} to={'/websites'} onClick={()=> {props.setValue(1); props.setSelectedIndex(3)}} className={classes.link}>Website Development</Grid>
                  </Grid>
              </Grid>
              <Grid item className={classes.gridItem}>
                  <Grid container direction="column" spacing={2}>
