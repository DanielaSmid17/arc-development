     ...
     style={{marginTop: matchesXS ? '1em' : "2em"}}>
        ...
        <Grid item container direction='column' className={classes.heading}>
            ...
            <Grid itm>
                ...
                <Typography variant='body1' align={matchesMD ? 'center' : undefined} paragraph>
                    Whether you want an app for your customers, employes, or yourself, we can build cross-platform native solutions for any part of your business process. 
    ...
    <Grid item container direction={matchesSM ? 'column' : 'row'} style={{marginTop:'15em', marginBottom: '15em'}} className={classes.rowContainer}>
        <Grid item container direction='column' md>
            ...
            <Grid item>
                ...
                <Typography variant='body1' align={matchesSM ? 'center' : undefined} paragraph>
                    This allows you to extend your react, reinvent interactions, 
                    and develop a stronger relationship with your users than ever before.
                </Typography>
            </Grid>
        </Grid>
        <Grid item md>
            <Lottie options={defaultOptions} style={{maxWidth: '20em', marginBottom: matchesMD ? '5em' : 0, marginTop: matchesMD ? '5em' : 0}} />
        </Grid>
        <Grid item container direction='column'  md>
            <Grid item>
